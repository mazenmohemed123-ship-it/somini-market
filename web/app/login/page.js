'use client';
// تسجيل الدخول/الإنشاء عبر البريد أو جوجل — بتصميم زجاج على خلفية الغابة/الأزرق.
      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div className="auth-card">
          ...
          <form onSubmit={submit}>
            ...
            {/* Divider */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', margin: '1rem 0', opacity: 0.6 }}>
              <div style={{ flex: 1, height: '1px', background: 'var(--auth-divider)' }}></div>
              <span style={{ fontSize: '0.75rem', color: 'var(--auth-label)' }}>أو</span>
              <div style={{ flex: 1, height: '1px', background: 'var(--auth-divider)' }}></div>
            </div>
